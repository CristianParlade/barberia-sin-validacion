...
class Email {
    ...
    public function enviarEmailParaRestablecer(){
        $mail = new PHPMailer();
        ...
        $mail->CharSet = 'UTF-8';
        $contenido = "<html>";
        $contenido .= "<p>Hola ". $this->nombre ." pincha el siguiente enlace para restablecer tu password</p>";
        $contenido .= "<p><a href='http://localhost:3000/restablecer?token=".$this->token."'>Pulsa el aquí</a></p>";
        $contenido .= "<p>Si no has solicitado este cambio ignora este mensaje</p>";
        $contenido .= "</html>";
